...
<div class="card-header">
    ...
    <div class="row">
        <div class="col-md-4" style="display:flex; justify-content: space-evenly;align-items: center"><h6 class="card-title"><strong>Name teacher: </strong> {{$student->Name }}</h6></div>
        <div class="col-md-4" style="display:flex; justify-content: space-evenly;align-items: center"><h6 class="card-title"><strong>Specialization: </strong> {{  $student->specializations->Name }}</h6></div>
        <div class="col-md-4" style="display:flex; justify-content: space-evenly;align-items: center"><h6 class="card-title"><strong>Joining Date  : </strong> {{$student->Joining_Date }}</h6></div>
    </div>
    <div class="row">
