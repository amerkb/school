                    ...
                    <div class="row">
                        <div class="col-md-6 border-right-2 border-right-blue-400">
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label font-weight-semibold">School Name</label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                <label for="current_session"
                                    class="col-lg-2 col-form-label font-weight-semibold">Current year<span
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label font-weight-semibold">Abbreviated school
                                    name</label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label font-weight-semibold">The end of the second
                                    term</label>
                                <div class="col-lg-9">
