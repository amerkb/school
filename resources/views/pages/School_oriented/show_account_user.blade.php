...
<div class="card-header">
    ...
    <div class="row">
        ...
        <div class="col-md-4" style="display:flex; justify-content: space-evenly;align-items: center"><h6 class="card-title"><strong>type: </strong> {{  $student->type_user->type }}</h6></div>
